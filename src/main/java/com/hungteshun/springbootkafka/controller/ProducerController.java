package com.hungteshun.springbootkafka.controller;

import com.google.gson.Gson;
import com.hungteshun.springbootkafka.common.ErrorCode;
import com.hungteshun.springbootkafka.common.MessageEntity;
import com.hungteshun.springbootkafka.common.Response;
import com.hungteshun.springbootkafka.producer.SimpleProducer;
...
public class ProducerController {
    ...
    public Response sendKafka(@RequestBody MessageEntity message) {
        try {
            ...
            log.error("消息发送失败", e);
            return new Response(ErrorCode.EXCEPTION, "消息发送失败");
        }
    }
}
